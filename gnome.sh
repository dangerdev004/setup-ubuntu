...
echo -e ${g}${b}gnome-maps${n} - A map navigator like google-maps for GNOME desktop
sleep 10s 
...
echo -e ${g}${b}CLOCK APP*${n} - for GNOME Desktop Environment
sleep 10s
...
echo THIS IS THE END OF THE SCRIPT${n}THANKYOU FOR USING THE SCRIPT${n}IF YOU HAVE ANY ISSUES PLEASE RAISE A ISSUE AT MY GITHUB REPO${n}
MY GITHUB REPO= https://github.com/dangerdev004 
